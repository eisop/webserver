...
/**
 * This is based on ClassFileManager posted by Miron Sadziak, August 20 2009,
 * http://www.javablogging.com/dynamic-in-memory-compilation/
 *
 * <p>The difference is that this allows multiple class files (for example when you have inner
 * classes), and exposes the compiled bytes of them.
 */
public class RAMClassFileManager extends ForwardingJavaFileManager<JavaFileManager> {
     ...
     * stored in the RAMClassFile, and returns the Class for it
     */
    @Override
    ...
    /**
     * Gives the compiler an instance of the RAMClassFile so that the compiler can write the byte
     * code into it.
     */
    @Override
