import org.checkerframework.checker.lock.qual.*; //for annotations @GuardedBy
import org.checkerframework.dataflow.qual.*; //for annotation @LockingFree
...
public class LockingFreeExampleWithWarnings {
    ...
    /*@LockingFree is useful when a method does not make any use of synchronization
    or locks but causes other side effects (hence @SideEffectFree is not appropriate). 
